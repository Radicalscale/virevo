...
- **New Value**: `BACKEND_URL=https://missed-variable.preview.emergentagent.com`
...
- **Date**: 2025-12-02
- **TO REVERSE**: Change `BACKEND_URL=https://missed-variable.preview.emergentagent.com` back to `BACKEND_URL=https://api.li-ai.org` in `/app/backend/.env` and restart backend
