...
curl -X GET "https://tts-guardian.preview.emergentagent.com/api/crm/qc-config" \
...
```bash
curl -X POST "https://tts-guardian.preview.emergentagent.com/api/crm/leads" \
...
```bash
curl -X POST "https://tts-guardian.preview.emergentagent.com/api/telnyx/call/outbound" \
  -H "Content-Type: application/json" \
  --cookie "access_token=YOUR_TOKEN" \
  -d '{
...
curl -X GET "https://tts-guardian.preview.emergentagent.com/api/crm/analytics/call/CALL_ID" \
  --cookie "access_token=YOUR_TOKEN"
```
...
```bash
# Get lead details
curl -X GET "https://tts-guardian.preview.emergentagent.com/api/crm/leads/LEAD_ID" \
  --cookie "access_token=YOUR_TOKEN"
